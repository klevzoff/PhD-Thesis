...
\subsubsection{Test Case 1}
Two mesh resolutions are used for each of the two scaling studies: \numproduct{100x100x100} (3.1M DoF) and \numproduct{140x140x140} (8.4M DoF) for multicore tests; \numproduct{200x200x200} (24.3M DoF) and \numproduct{280x280x280} (66.5M DoF) for multi-node tests.   Because of constraints imposed by GEOSX's memory footprint, some of the higher-resolution models could only be run on a larger number of cluster nodes.
