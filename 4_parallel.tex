...
\begin{figure} [htbp]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/weak/mech/mpi_iter.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/weak/mech/mpi_time}
    \input{figs/MazuModel2/geosx/scaling/weak/mech/mpi_time.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/weak/flow/mpi_iter}
    \input{figs/MazuModel2/geosx/scaling/weak/flow/mpi_iter.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/weak/flow/mpi_time}
    \input{figs/MazuModel2/geosx/scaling/weak/flow/mpi_time.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/weak/poro/mpi_iter}
    \input{figs/MazuModel2/geosx/scaling/weak/poro/mpi_iter.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/weak/poro/mpi_time}
    \input{figs/MazuModel2/geosx/scaling/weak/poro/mpi_time.tex}
  \end{subfigure}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/Cart/scaling/strong/mech/omp_100x100x100_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/omp_140x140x140_time}
    \input{figs/Cart/scaling/strong/mech/omp_140x140x140_time.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/mpi_200x200x200_time}
    \input{figs/Cart/scaling/strong/mech/mpi_200x200x200_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/mpi_280x280x280_time}
    \input{figs/Cart/scaling/strong/mech/mpi_280x280x280_time.tex}
  \end{subfigure}
  \caption[Test case 1 geomechanics problem strong scaling]{Test case 1 geomechanics problem strong scaling: setup/solve times for shared memory (top) and distributed memory (bottom) tests.}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/Cart/scaling/strong/flow/omp_100x100x100_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/flow/omp_140x140x140_time}
    \input{figs/Cart/scaling/strong/flow/omp_140x140x140_time.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/flow/mpi_200x200x200_time}
    \input{figs/Cart/scaling/strong/flow/mpi_200x200x200_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/flow/mpi_280x280x280_time}
    \input{figs/Cart/scaling/strong/flow/mpi_280x280x280_time.tex}
  \end{subfigure}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/Cart/scaling/strong/poro/omp_100x100x100_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/poro/omp_140x140x140_time}
    \input{figs/Cart/scaling/strong/poro/omp_140x140x140_time.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/poro/mpi_200x200x200_time}
    \input{figs/Cart/scaling/strong/poro/mpi_200x200x200_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/poro/mpi_280x280x280_time}
    \input{figs/Cart/scaling/strong/poro/mpi_280x280x280_time.tex}
  \end{subfigure}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/strong/mech/omp_3_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
  \hspace{\textwidth}
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/strong/mech/mpi_4_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/strong/mech/mpi_5_time}
    \input{figs/MazuModel2/geosx/scaling/strong/mech/mpi_5_time.tex}
  \end{subfigure}
...
\paragraph{Flow}
The timings for this problem are presented in \cref{fig:mazumodel2_scaling_strong_flow}.   We observe a similar trend of scaling up to 16 cores in shared memory and 32-64 nodes (depending on the problem) in distributed memory.   Notably, the solve phase of MS exhibits poor scaling between 32 and 64 nodes, especially for the smaller problem on grid 4, which be attributed to the use of a serial (single-rank) coarse level solver.   The setup phase, on the other hand, scales almost perfectly on multiple nodes, but worse in multicore setting.

\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/strong/flow/omp_3_time}
    \input{figs/MazuModel2/geosx/scaling/strong/flow/omp_3_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
  \hspace{\textwidth}
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/strong/flow/mpi_4_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/strong/flow/mpi_5_time}
    \input{figs/MazuModel2/geosx/scaling/strong/flow/mpi_5_time.tex}
  \end{subfigure}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/strong/poro/omp_3_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
  \hspace{\textwidth}
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \input{figs/MazuModel2/geosx/scaling/strong/poro/mpi_4_time.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/MazuModel2/geosx/scaling/strong/poro/mpi_5_time}
    \input{figs/MazuModel2/geosx/scaling/strong/poro/mpi_5_time.tex}
  \end{subfigure}
...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/omp_100x100x100_kernels_setup}
    \input{figs/Cart/scaling/strong/mech/omp_100x100x100_kernels_setup.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/omp_100x100x100_kernels_solve}
    \input{figs/Cart/scaling/strong/mech/omp_100x100x100_kernels_solve.tex}
  \end{subfigure}
  \pgfplotsset{
    StrongScalingKernelPlot/.append style = { enlarge x limits = 0.3 },
  }
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/mpi_280x280x280_kernels_setup}
    \input{figs/Cart/scaling/strong/mech/mpi_280x280x280_kernels_setup.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \tikzsetnextfilename{figs/Cart/scaling/strong/mech/mpi_280x280x280_kernels_solve}
    \input{figs/Cart/scaling/strong/mech/mpi_280x280x280_kernels_solve.tex}
  \end{subfigure}
