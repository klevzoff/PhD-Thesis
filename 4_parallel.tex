...
\begin{figure} [htbp]
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \end{tikzpicture}
    \caption{}
    \label{fig:cart_mech_scaling_weak_omp_iter}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    ...
    \end{tikzpicture}
    \caption{}
    \label{fig:cart_mech_scaling_weak_mpi_iter}
  \end{subfigure}
  \par\bigskip 
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    ...
    \end{tikzpicture}
    \caption{}
    \label{fig:cart_mech_scaling_weak_omp_time}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    ...
    \end{tikzpicture}
    \caption{}
    \label{fig:cart_mech_scaling_weak_mpi_time}
  \end{subfigure}
  \caption[3D Cartesian mechanics example weak scaling]{3D Cartesian mechanics example weak scaling: iterations and setup/solve times}
  \label{fig:cart_mech_scaling_weak}
\end{figure}
